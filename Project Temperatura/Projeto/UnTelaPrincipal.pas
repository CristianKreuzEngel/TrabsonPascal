...
begin
    ...
    if ((cbMedida.ItemIndex = 1) and (imgKelvin.Visible = true)) then
      ...
      begin
        ShowMessage ('Para a conversão de Kelvin (K) para Celsius (°C) utiliza-se a seguinte fórmula:((Medida em Kelvin)) - 273.15)');
      end;
