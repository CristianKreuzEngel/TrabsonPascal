...
begin
    ...
    if ((cbMedida.ItemIndex = 1) and (imgKelvin.Visible = true)) then
      ...
      begin
        ShowMessage('Para a conversão de Celsius(°C) para Celsius (°C),o valor nao mudará, pois foi escolhida é a mesma.');
      end;

      //Mensagem de Fahrenheit para as outras medidas
      if ((cbMedida.ItemIndex = 2) and (imgFahrenheit.Visible = true)) then
      begin
        ShowMessage ('Para a conversão de Fahrenheit (°F) para Fahrenheit (°F), o valor nao mudará, pois foi escolhida é a mesma.');
      end;
      ...
      begin
        ShowMessage ('Para a conversão de Kelvin (K) para Kelvin (K), o valor nao mudará, pois foi escolhida é a mesma.')
      end;
end;
